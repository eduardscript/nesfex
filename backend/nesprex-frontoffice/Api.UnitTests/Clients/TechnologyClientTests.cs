...
public class TechnologyClientTests : BaseTests
{
    ...
    public async Task ShouldThrow_WhenUserTechnologyDoesNotExist()
    {
        ...
        operationResult
            .Data
            .Returns(new GetTechnologiesResult(new List<IGetTechnologies_Technologies>()));
        ...
        var exception = await Assert.ThrowsAsync<GraphQLException>(() => technologyClient
            .GetTechnologies(userTechnologyNames));
    ...
    public async Task ShouldThrow_WhenBackofficeServiceIsDown()
    {
        ...
        operationResult
            .Data
            .Returns((IGetTechnologiesResult)null!);
